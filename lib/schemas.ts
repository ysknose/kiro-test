...
/**
 * 備品更新用バリデーションスキーマ（部分更新対応）
 * すべてのフィールドがオプショナル
 * 要件: 5.1
 */
export const EquipmentUpdateSchema = v.partial(EquipmentSchema);
 ...
 * 備品更新用の入力型
 */
export type EquipmentUpdateInput = v.InferInput<typeof EquipmentUpdateSchema>;

/**
 * 備品更新用の出力型
 */
export type EquipmentUpdateOutput = v.InferOutput<typeof EquipmentUpdateSchema>;
